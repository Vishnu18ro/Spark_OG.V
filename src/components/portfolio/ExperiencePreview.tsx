  ...
  return (
    <div className="bg-card/50 backdrop-blur-sm border border-primary/30 rounded-lg p-8 shadow-glow-primary">
      ...
      {displayedItems.length > 0 ? (
        <div className="grid gap-6 md:grid-cols-2 transition-all duration-500 ease-in-out">
                ...
                <div className="flex gap-4">
                  ...
                  <div className="flex-1 space-y-3">
                    <div className="flex items-start justify-between">
                      ...
                      <Badge variant="outline">{exp.type === 'Custom' ? (exp.customType || 'Custom') : exp.type}</Badge>
                    </div>
